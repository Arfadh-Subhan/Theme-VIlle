...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (backBtn) {
        backBtn.addEventListener('click', function() {
            // Option 1: Go back in history (if user came from your app)
            // window.history.back();
            
            // Option 2: Go directly to your main app
            window.location.href = 'index.html'; // or your main HTML file name
            
            // Option 3: Open in new tab (keeps dragon open)
